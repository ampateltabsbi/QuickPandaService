...
export class BasicLoginComponent implements OnInit {
  ...
  onLoggedin() {
    ...
    if (this.urlArrayLength === 4) {
      debugger;
      const a =  this.apiService.selectedModel.email;
      const b =  this.apiService.selectedModel.password;
      // this.apiService.getModelListById('CompanyResource', this.apiService.selectedModel.email, this.apiService.selectedModel.password, 'ValidateLogIn')
