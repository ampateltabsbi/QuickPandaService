...
export class VerificationComponent implements OnInit {
  ...
  onSubmit(verificationForm: NgForm) {
    ...
    var verifyCode = this.apiService.selectedModel.VeriCode1 +''+ this.apiService.selectedModel.VeriCode2 +''+ this.apiService.selectedModel.VeriCode3 +''+ this.apiService.selectedModel.VeriCode4 + this.apiService.selectedModel.VeriCode1 + this.apiService.selectedModel.VeriCode1
    this.apiService
