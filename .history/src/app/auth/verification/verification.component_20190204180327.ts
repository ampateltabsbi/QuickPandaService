...
export class VerificationComponent implements OnInit {
  ...
  onSubmit(verificationForm: NgForm) {
    ...
    this.verifyCode = this.verifyCode + '' + this.apiService.selectedModel.VerifyCode3;
    this.verifyCode = this.verifyCode + '' + this.apiService.selectedModel.VerifyCode4;
    this.verifyCode = this.verifyCode + '' + this.apiService.selectedModel.VerifyCode5;
    this.verifyCode = this.verifyCode + '' + this.apiService.selectedModel.VerifyCode6;
