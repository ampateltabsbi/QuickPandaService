...
export class VerificationComponent implements OnInit {
  ...
  onSubmit(verificationForm: NgForm) {
    ...
    this.verifyCode = this.apiService.selectedModel.VeriCode1 + '' + this.apiService.selectedModel.VeriCode2;
    verifyCode = verifyCode + '' + this.apiService.selectedModel.VeriCode3;
    verifyCode = verifyCode + '' + this.apiService.selectedModel.VeriCode4;
    verifyCode = verifyCode + '' + this.apiService.selectedModel.VeriCode5;
    verifyCode = verifyCode + '' + this.apiService.selectedModel.VeriCode6;
