...
export class VerificationComponent implements OnInit {
  ...
  onSubmit(verificationForm: NgForm) {
    ...
    verifyCode = verifyCode '' +this.apiService.selectedModel.VeriCode3 + '' + this.apiService.selectedModel.VeriCode4 + '' + this.apiService.selectedModel.VeriCode5 + '' + this.apiService.selectedModel.VeriCode6;
    this.apiService
